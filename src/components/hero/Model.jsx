...
function Model(props) {
  ...
  useFrame((state, delta) => {
    state.camera.position.set(Math.sin(props.dataParentToChild  * 4) * 10, Math.atan(props.dataParentToChild  * Math.PI * 2) * 4, Math.cos(props.dataParentToChild  * Math.PI) * -10)
